...
class GlobalConfig
  class << self
    ...
    def dig(*parts, default: :__no_default_provided__)
      # Special handling for secure_external_id to create nested hash structure
      if parts.first.to_sym == :secure_external_id
        primary_key_version = get("SECURE_EXTERNAL_ID__PRIMARY_KEY_VERSION")
        keys_1 = get("SECURE_EXTERNAL_ID__KEYS__1")
        
        return default if primary_key_version.blank? && keys_1.blank?
    ...
    private
      ...
      DUMMY_VALUE_SECRETS = %w[
        ...
        SECURE_EXTERNAL_ID__PRIMARY_KEY_VERSION
        SECURE_EXTERNAL_ID__KEYS__1
      ].freeze
      ...
      DUMMY_VALUES = {
        ...
        "SECURE_EXTERNAL_ID__KEYS__1" => "dummy32byteencryptionkeyfortest1",
        "PAYPAL_PARTNER_CLIENT_ID" => "dummy_paypal_partner_client_id",
        "PAYPAL_PARTNER_MERCHANT_ID" => "DUMMY_PARTNER_MERCHANT_12345",
        "PAYPAL_PARTNER_MERCHANT_EMAIL" => "dummy@paypalpartner.test"
      }.freeze
  end
